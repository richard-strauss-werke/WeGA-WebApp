...
<xsl:stylesheet xmlns="http://www.tei-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:functx="http://www.functx.com" xmlns:xs="http://www.w3.org/2001/XMLSchema" version="2.0">
    
<!--  ****************  -->
<!--  AHTUNG: Die Kommentarknoten wurde nicht übernommen!  -->
<!--  ****************  -->
    <xsl:output name="xml" indent="yes" encoding="UTF-8" method="xml" omit-xml-declaration="no" exclude-result-prefixes="xsl"/>
    <xsl:output indent="yes" encoding="UTF-8" method="xml" omit-xml-declaration="no" exclude-result-prefixes="xsl tei"/>
    <xsl:param name="id"/>
